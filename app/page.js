          ...
          <div className=' relative w-[80%] h-[80%] text-white'>
            <div className='flex items-center justify-center flex-col gap-3 h-full'>
              ...
              <div className='flex items-center justify-start gap-3'>
                <motion.div  ><button className='text-white bg-pink-600 rounded-full border-none glow' >Resume</button></motion.div>
                <motion.div ><button className='text-white bg-pink-600 rounded-full border-none glow' onClick={() => { Move("contactmove") }}>Hire Me</button></motion.div>
