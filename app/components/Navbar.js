...
const Navbar = () => {
    ...
    return (
      <div className={`fixed  z-20 w-[100vw] h-[50px] trans flex items-center justify-center border-pink-600 max-sm:border max-sm:rounded-full max-sm:w-[60vw] max-sm:ml-[20vw]  max-sm:bg-black duration-700 ${visible ? 'max-sm:top-5' : 'max-sm:-top-14'} `}>
