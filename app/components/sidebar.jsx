...
const sidebar = () => {
    return (
        <div className='w-[100px] h-[full] flex flex-col items-center justify-center gap-5 text-xl'>
            ...
            <a href='https://github.com/techshadow01' target="_blank"><motion.div whileHover={{ scale: 1.2 }}><MailOutlineIcon className='text-white size-10 cursor-pointer hover:text-pink-600' /></motion.div></a>
        </div>
    )
}
